...
const id = () => {
  ...
  const categoryInfo = incomeCategories.find(
  ...
  const moreIncomesInCategoryRender = moreIncomesInCategory?.documents?.filter(
    (doc) => doc.$id !== id
  );
          ...
          <div className="flex items-start flex-col md:flex-row w-full gap-10 px-4">
            ...
            <div className="md:w-[40%] w-full">
              ...
              <div className="flex flex-col gap-3">
                {moreIncomesInCategoryRender?.length !== 0 ? (
                  <>
                    <EmptyTwoDocs subtitle="No More Incomes in this category" />{" "}
                  </>
                ) : (
                  moreIncomesInCategoryRender?.map((doc) => {
