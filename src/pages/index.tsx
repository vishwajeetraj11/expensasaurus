  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Track and manage your finances effortlessly with Expensasaurus. Take control of your budget, monitor spending, and achieve your financial goals."
        />
        <meta
          name="keywords"
          content="expense tracker, budget management, financial planning, personal finance"
        />
        <meta name="author" content="Vishwajeet Raj" />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Expensasaurus - Track and Manage Your Finances"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://cloud.appwrite.io/v1/storage/buckets/647581bae5f8d8dac87f/files/64861233ae623b136b44/view?project=645fde38a1fc2e10a9a7&mode=admin"
        />
